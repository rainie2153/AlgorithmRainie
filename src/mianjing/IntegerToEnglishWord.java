...
public class IntegerToEnglishWord {
    ...
    private String trans(int num) {
        if (num == 0) {
            ...
            return LESS_THAN_20[num / 100] + " Hundred and" + trans(num % 100);
        }
    }

    public static void main(String[] args) {
        IntegerToEnglishWord test = new IntegerToEnglishWord();
        System.out.print(test.numberToWords(Integer.MAX_VALUE));
    }
}
